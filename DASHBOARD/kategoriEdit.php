...
<?php
  ...
  if(isset($_POST['Edit']))
  {
  	...
  	mysqli_query($connection, "UPDATE kategori SET kategorinama = '$Kategorinama', kategoriket = '$Kategoriket', kategorireferensi = '$Kategoriref' WHERE kategoriID = '$Kategorikode'");
    ...
    <div class="col-sm-10">
      ...
      <form method="POST">
		  <div class="form-group row">
		    ...
		    <div class="col-sm-10">
		      <input type="text" class="form-control" id="kodekategori" name="inputkode" value="<?php echo $rowedit["kategoriID"]?>"
		  ...
		  <div class="form-group row">
		    ...
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="inputnama"id="namakategori"value="<?php echo $rowedit["kategorinama"]?>">
		    </div>
		  </div>
		  ...
		  <div class="form-group row">
		    ...
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="inputket"id="ketkategori" value="<?php echo $rowedit["kategoriket"]?>">
		    </div>
		  </div>
		  ...
		  <div class="form-group row">
		    ...
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="inputref"id="refkategori" value="<?php echo $rowedit["kategorireferensi"]?>">
		    </div>
		  </div>
		 ...
		 <input type="button"  onclick="window.location.href='kategori.php'" class="btn btn-secondary" value="Batal" name="Batal">
		    </div>
		  </div>
