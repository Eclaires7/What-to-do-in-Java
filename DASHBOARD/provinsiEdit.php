...
<?php
  ...
  if(isset($_POST['Edit']))
  {
  	...
  	mysqli_query($connection, "UPDATE provinsi SET provinsinama = '$Provinsinama', provinsitglberdiri = '$Provinsitgl' WHERE provinsiID = '$Provinsikode'");
    header("location:provinsi.php");
  }

  //untuk menampilkan data pada form edit
  $kodeprovinsi = $_GET["edit"];
...
<div class="row">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" name="inputkode"id="kodeprovinsi" value="<?php echo $rowedit["provinsiID"]?>" maxlength="2" readonly>
        </div>
      </div>
		  ...
		  <div class="form-group row">
		    ...
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="inputnama"id="namaprovinsi"value="<?php echo $rowedit["provinsinama"]?>">
		    </div>
		  </div>
		  ...
		  <div class="form-group row">
		    ...
		    <div class="col-sm-10">
		      <input type="date" class="form-control" name="inputtgl" data-provide="datepicker" id="tglprovinsi" value="<?php echo $rowedit["provinsitglberdiri"]?>">
		    </div>
		  </div>
     ...
     <input type="button"  onclick="window.location.href='provinsi.php'" class="btn btn-secondary" value="Batal" name="Batal">
		    </div>
		  </div>
          ...
          } else
          {
            ...
            { ?>
              <tr>
                ...
                <td>
                  <a href="provinsiEdit.php?edit=<?php echo $row["provinsiID"]?>" class="btn btn-success btn-sm" title="Edit">
