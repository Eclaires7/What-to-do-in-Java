...
<?php
  ...
  if(isset($_POST['Edit']))
  {
    ...
    mysqli_query($connection, "UPDATE area SET areanama = '$Areanama', areawilayah = '$Areawilayah', areaketerangan = '$Areaketerangan', provinsiID = '$Provinsikode' WHERE areaID = '$Areakode'");
  ...
  $editprovinsi = mysqli_query($connection, "SELECT * FROM area JOIN provinsi USING(provinsiID) WHERE areaID = '$kodearea'");
    ...
    <div class="col-sm-10">
      ...
      <form method="POST">
		  <div class="form-group row">
		    ...
		    <div class="col-sm-10">
		      <input type="text" class="form-control" id="kodearea" name="inputkodearea" value="<?php echo $rowedit["areaID"]?>" readonly
		      maxlength="4">
		    </div>
		  </div>
		  ...
		  <div class="form-group row">
		    ...
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="inputnama"id="namaarea"value="<?php echo $rowedit["areanama"]?>">
		    </div>
		  </div>
		  ...
		  <div class="form-group row">
		    ...
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="inputwilayah"id="wilayaharea" value="<?php echo $rowedit["areawilayah"]?>">
		    </div>
		  </div>
		  ...
		  <div class="form-group row">
		    ...
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="inputket"id="ketarea" value="<?php echo $rowedit["areaketerangan"]?>">
		    </div>
		  </div>
     ...
     <input type="button"  onclick="window.location.href='area.php'" class="btn btn-secondary" value="Batal" name="Batal">
		    </div>
		  </div>
