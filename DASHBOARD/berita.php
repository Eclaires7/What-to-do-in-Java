  ...
  <?php 
    ...
    if(isset($_POST['Simpan']))
    {
      ...
      else
      {
        ...
        mysqli_query($connection, "insert into berita values ('$Beritakode', '$Beritajudul', '$Beritaket', '$Destinasikode')");
        ...
        <div class="col-sm-10">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" id="ketberita" name="inputket" placeholder="Keterangan Berita"></textarea>
                    </div>
                </div>
