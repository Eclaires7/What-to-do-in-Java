...
<?php 
  ...
  if(isset($_POST['Simpan']))
  {
  	...
  	mysqli_query($connection, "insert into hotel values ('$Hotelkode', '$Hotelnama', '$Hotelalamat', '$Destinasikode')");
    ...
    <div class="col-sm-10">
      ...
      <form method="POST">
		  ...
		  <div class="form-group row">
		    ...
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="inputnama"id="namahotel"placeholder="Nama Hotel">
		    </div>
		  </div>
		  ...
		  <div class="form-group row">
		    ...
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="inputalamat"id="alamathotel" placeholder="Alamat Hotel">
		    </div>
		  </div>
