...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar" style="background: rgb(37,52,68);background: linear-gradient(180deg, rgba(37,52,68,1) 0%, rgba(84,103,116,1) 33%, rgba(236,191,152,1) 100%);;">

            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                <div class="sidebar-brand-icon rotate-n-15">
                    <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-emoji-sunglasses-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="nav-item">
                <a class="nav-link" href="index.php">
                    ...
                    <span style="margin-left: 8px">Dashboard</span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
                    ...
                    <span style="margin-left: 8px">Wisata</span>
                </a>
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Input dan Daftar:</h6>
                        <a class="collapse-item" href="destinasi.php">Destinasi Wisata</a>
                        <a class="collapse-item" href="fotodestinasi.php">Foto Destinasi Wisata</a>
                        <a class="collapse-item" href="berita.php">Berita Wisata</a>
                        <a class="collapse-item" href="hotel.php">Hotel Dekat Wisata</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities"
                    ...
                    <span style="margin-left: 8px">Wilayah</span>
                </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="yourinfo.php">Your Info</a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="about.php">
                    ...
                    <span style="margin-left: 8px">About</span></a>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"> <?php echo $row['adminnama']?></span>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="yourinfo.php">
